...
const CREDIT_PACK = { credits: 5, amountKobo: 20000, label: "20 extra generations — ₦200" }; // amountKobo is in kobo (₦200 = 20000 kobo)
...
Never use LaTeX or math markup (no $, $$, \(, \[, or similar delimiters). Write all math in plain text using standard characters — e.g. "x^2 + 3x - 4 = 0", "√16" (use the actual √ symbol, never the word "sqrt"), "5/8", "3.14", not LaTeX commands or dollar-sign wrappers.`;
